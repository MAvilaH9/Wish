                ...
                <div class="col-12 stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" class="forms-sample" action="../Recursos/AgregarProd.php" method="Post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12"> 
                                        ...
                                        <textarea class="form-control" name="Descripcion" required cols="4" rows="4"></textarea>
                                    </div>
                                </div> <br>
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input type="text" class="form-control" name="Preciodescuento" placeholder="Precio descuento"
                                            required>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
