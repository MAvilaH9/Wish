	...
	<div class="container">
				...
				<div class="wrap-table-shopping-cart">
					<table class="table-shopping-cart">
						...
						<tr class="table_row">
							...
							<td class="column-6"><a href="../Recursos/DeleteCarrito.php?IdCarrito=<?php echo $dato['IdCarrito'];?>" onclick="funcionAlertaE()">Eliminar</a></td>
		...
		<div class="col-sm-10 col-lg-7 col-xl-8 m-lr-auto m-b-50">
			<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm" >
				...
				<a href="Index.php" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Continuar Comprando</a> 
			</div>
		</div>
		<?php }?>
		</div>
